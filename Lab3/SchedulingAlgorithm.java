...
public class SchedulingAlgorithm {
    ...
    public static Results run(int runtime, Vector<sProcess> processVector, Results result, String logFile) {
        ...
        Comparator cmp = new ProcessComparator();
        ...
        try {
            ...
            while (comptime < runtime) {
                if (process.cpudone == process.cputime) {
                    completed++;
                    out.println("Process: " + process.number + " completed... (" + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.priority + ")");
                    if (completed == size) {
                ...
                if (process.ioblocking == process.ionext) {
                    out.println("Process: " + process.number + " I/O blocked... (" + process.cputime + " " + process.ioblocking +" " + process.cpudone + " " + process.priority + ")");
                    process.numblocked++;
                    process.ionext = 0;
